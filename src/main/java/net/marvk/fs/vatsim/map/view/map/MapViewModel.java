...
//        Bindings.bindContent(statusScope.highlightedFirs(), contextMenu.getFirbs().getItems());
    ...
    private ObservableList<PainterExecutor<?>> executors(final UpperInformationRegionRepository upperInformationRegionRepository) {
        return FXCollections.observableArrayList(
                ...
                PainterExecutor.ofCollection("Inactive Flight Information Regions", "Inactive Firs", new InactiveFirbPainter(mapVariables), this::isNotSelected, this::flightInformationRegionBoundaries),
                PainterExecutor.ofCollection("Inactive Upper Information Regions", "Inactive Uirs", new InactiveUirPainter(mapVariables), this::isNotSelected, upperInformationRegionRepository::list),
                PainterExecutor.ofCollection("Active Upper Information Regions", "Active Uirs", new ActiveUirPainter(mapVariables), this::isNotSelected, upperInformationRegionRepository::list),
                PainterExecutor.ofCollection("Active Flight Information Regions", "Active Firs", new ActiveFirbPainter(mapVariables), this::isNotSelected, this::flightInformationRegionBoundaries),
                PainterExecutor.ofItem("Flight Tracks", "Connections", new ConnectionsPainter(mapVariables), this.selectedItemProperty()::get),
                PainterExecutor.ofCollection("Flights", "Pilots", new PilotPainter(mapVariables), this::isNotSelected, this::pilots),
                PainterExecutor.ofCollection(null, "Filters", new FilterPainter(mapVariables, filterRepository.list()), this::isNotSelected, this::pilots),
                PainterExecutor.ofCollection(null, "Airports", new AirportPainter(mapVariables), this::isNotSelected, this::airports),
                PainterExecutor.ofCollection(null, "Search Items", new SelectedPainter(mapVariables, Color.DEEPSKYBLUE, true), this::isNotSelected, statusScope::getSearchedData),
